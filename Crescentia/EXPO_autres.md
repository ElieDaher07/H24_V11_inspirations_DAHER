...
<div style="display: flex; align-items: flex-start;">
    <div style="flex: 1;">
        <img width="500" height="auto" src="media/sonalux_installation_01.png" style="float: left; clear: none; margin-right: 10px;">
    <div style="flex: 3; display: flex; flex-direction: column;">
        <img width="500" src="media/sonalux_schema.png" style="margin-bottom: 10px;">
        <img width="500"src="media/sonalux_installation_02.png" style="margin-bottom: 10px;">
